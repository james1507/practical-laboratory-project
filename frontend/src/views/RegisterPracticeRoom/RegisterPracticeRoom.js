...
const RegisterPracticeRoomLearn = () => {
  const title = "Tạo mới phòng thực hành";
  const message = "Đây là trang tạo mới phòng thực hành";
  ...
  const handleRegister = () => {
    ...
    axios
      .post(`http://localhost:8000/api/practice-rooms`, formData)
      .then((response) => {
            ...
            <Card className="bg-secondary shadow">
              <CardHeader className="bg-white border-0">
                <Row className="align-items-center">
                  <Col xs="8">
                    <h3 className="mb-0">Tạo phòng thực hành</h3>
                  </Col>
                </Row>
              </CardHeader>
              <CardBody>
...
export default RegisterPracticeRoomLearn;
