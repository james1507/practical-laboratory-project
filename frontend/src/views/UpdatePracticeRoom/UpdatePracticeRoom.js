...
const UpdatePracticeRoom = () => {
  ...
  const [idMatchSchedule, setIdMatchSchedule] = useState("");

  useEffect(() => {
    // Parse the query parameters and get the value of IdMatchSchedule
    const searchParams = new URLSearchParams(location.search);
    const idMatchScheduleParam = searchParams.get("IdMatchSchedule");

    if (idMatchScheduleParam) {
      setIdMatchSchedule(idMatchScheduleParam);
    }
  }, [location.search]);
...
export default UpdatePracticeRoom;
